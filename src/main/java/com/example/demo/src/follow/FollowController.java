...
public class FollowController {
    ...
    @ResponseBody
    @GetMapping("/followers/{userId}") // (GET) 127.0.0.1:9000/app/users/:userId
    public BaseResponse<GetFollowerListRes> getFollowers(@PathVariable("userId") int userId) {
        // Get Follows
        try {
    ...
    @ResponseBody
    @GetMapping("/followed/{userId}") // (GET) 127.0.0.1:9000/app/users/:userId
    public BaseResponse<GetFolloweeListRes> getFollowees(@PathVariable("userId") int userId) {
        // Get Follows
        try {
